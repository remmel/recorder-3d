...
public class ImageUtilsTest {
    ...
    private static final String DEPTH16 = DIR + "/00000012.depth16.bin";
    private static final String PLY = DIR + "/00000012.ply";
    private static final String JPEG = DIR + "/00000012_image.jpg";
    private static final String IMAGE_YUVNV26 =  DIR + "/00000012.image.bin";
    ...
    public void writePly() throws IOException {
        ...
        byte[] bytesYuvNv21 = Files.readAllBytes(Paths.get(IMAGE_YUVNV26));
